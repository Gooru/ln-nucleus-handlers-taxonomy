...
class FetchSubjectsHandler implements DBHandler {
    ...
    public ExecutionResult<MessageResponse> checkSanity() {
        ...
        if (context.request() == null || classification == null || classification.isEmpty()) {
            ...
            return new ExecutionResult<>(MessageResponseFactory
                .createInvalidRequestResponse(RESOURCE_BUNDLE.getString("missing.classification.type")),
    ...
    public ExecutionResult<MessageResponse> executeRequest() {
        LazyList<AJEntityDefaultSubject> results =
            AJEntityDefaultSubject.where(AJEntityDefaultSubject.SUBJECTS_GET, this.classificationType)
                .orderBy(HelperConstants.SEQUENCE_ID);
        return new ExecutionResult<>(MessageResponseFactory.createOkayResponse(new JsonObject()
            .put(HelperConstants.SUBJECTS, new JsonArray(
