...
class FetchCoursesHandler implements DBHandler {
    ...
    public ExecutionResult<MessageResponse> checkSanity() {
        ...
        if (context.subjectId() == null || context.subjectId().isEmpty() || context.standardFrameworkId() == null
    ...
    public ExecutionResult<MessageResponse> executeRequest() {
        LazyList<AJEntityTaxonomyCourse> results = AJEntityTaxonomyCourse
            .where(AJEntityTaxonomyCourse.COURSES_GET, context.subjectId(), context.standardFrameworkId(),
