...
class AJTaxonomyRepo implements TaxonomyRepo {
  ...
  public MessageResponse fetchSubjects() {
    return TransactionExecutor
        .executeTransaction(DBHandlerBuilder.buildFetchSubjectsHandler(context));
  }

  @Override
  public MessageResponse fetchCourses() {
    return TransactionExecutor
        .executeTransaction(DBHandlerBuilder.buildFetchCoursesHandler(context));
  }

  @Override
  public MessageResponse fetchDomainStandards() {
    return TransactionExecutor
        .executeTransaction(DBHandlerBuilder.buildFetchDomainStandardsHandler(context));
  ...
  public MessageResponse fetchDomains() {
    return TransactionExecutor
        .executeTransaction(DBHandlerBuilder.buildFetchDomainsHandler(context));
  }
  ...
  public MessageResponse fetchCrosswalkGDFWCodes() {
    return TransactionExecutor
        .executeTransaction(DBHandlerBuilder.buildFetchCrosswalkGDFWCodesHandler(context));
  }

  @Override
  public MessageResponse fetchCrosswalkFWCodes() {
    return TransactionExecutor
        .executeTransaction(DBHandlerBuilder.buildFetchCrosswalkFWCodesHandler(context));
  }

  @Override
  public MessageResponse transformTaxonomy() {
    return TransactionExecutor
        .executeTransaction(DBHandlerBuilder.buildTaxonomyTransformationHandler(context));
  }

  @Override
  public MessageResponse fetchStandardFrameworks() {
    return TransactionExecutor
        .executeTransaction(DBHandlerBuilder.buildFetchStandardFrameworksHandler(context));
  }

  @Override
  public MessageResponse fetchSubjectClassifications() {
    return TransactionExecutor
        .executeTransaction(DBHandlerBuilder.buildFetchSubjectClassificationsHandler(context));
  }
