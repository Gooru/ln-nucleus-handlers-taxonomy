...
public class AJEntityFramework extends Model {
  ...
  public static final String  STANDARD_FRAMEWORKS = "select sf.id as standard_framework_id, sf.title, s.id as taxonomy_subject_id, s.title as taxonomy_subject_title "
      ...
      + "AND sf.tenant = ANY(?::uuid[]) ORDER BY sf.tenant, sf.sequence_id";
  public static final String STANDARD_FRAMEWORK = "tenant = ANY(?::uuid[])";
}
