...
public final class HelperConstants {
  ...
  public final static String[] TX_RESPONSE_FIELDS = {"id", "code", "title", "description",
      "has_standard_framework", "sequence_id"};
  ...
  public final static String CROSSWALK = "crosswalk_data";
  ...
  public final static String[] TX_DOMAIN_RESPONSE_FIELDS = {"id", "default_taxonomy_domain_id",
      "code", "title", "description", "sequence_id"};
  public final static String[] TX_CODES_RESPONSE_FIELDS = {"id", "parent_taxonomy_code_id", "code",
      "title", "description", "code_type", "is_selectable", "sequence_id"};
  public final static String[] TX_CROSSWALK_CODES_RESPONSE_FIELDS = {"target_display_code",
