...
public final class HelperConstants {
    ...
    public final static String[] TX_COURSE_RESPONSE_FIELDS =
        { "default_course_id", "code", "title", "description", "grades" };
    public final static String[] TX_DOMAIN_RESPONSE_FIELDS = { "default_domain_id", "code", "title", "description" };
    public final static String[] TX_CODES_RESPONSE_FIELDS =
        { "default_code_id", "code", "title", "description", "type", "is_selectable" };
    public final static String[] TX_DUMMY_CODES_RESPONSE_FIELDS =
        { "id", "code", "title", "description", "type", "is_selectable" };
