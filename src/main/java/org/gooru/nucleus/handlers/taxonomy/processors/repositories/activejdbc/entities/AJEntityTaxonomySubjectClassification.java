...
public class AJEntityTaxonomySubjectClassification extends Model {
  ...
  public static final String SELECT_TAXONOMY_SUBJECT_CLASSIFICATIONS_GOLBAL =
      "SELECT id, title, code FROM taxonomy_subject_classification WHERE tenant_visibility = true "
