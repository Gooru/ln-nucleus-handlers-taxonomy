...
class FetchCrosswalkFWCodesHandler implements DBHandler {
    ...
    public ExecutionResult<MessageResponse> executeRequest() {
        ...
        final String key = (this.isInternalCode == null || !this.isInternalCode) ? HelperConstants.TARGET_DISPLAY_CODE
        ...
        if (targetCodes != null && targetCodes.size() > 0) {
            ...
            if (codes != null && codes.size() > 0) {
                codes.forEach(code -> {
                    results.put(code.getString(key), new JsonObject(JsonFormatterBuilder.buildSimpleJsonFormatter(false,
